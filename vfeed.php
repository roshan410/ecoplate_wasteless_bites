...
<body>
        ...
        <div class="nav-content" >
            ...
            <div class="nav-links">
               ...
               <i class="fa-solid fa-cart-shopping"></i>
				...
				<a href="vfeed.php" class="nav-link active">
  ...
  <h3 style="text-align: center; color: #2c3e50; font-size: 24px; margin: 30px 0; font-family: Arial, sans-serif; border-bottom: 2px solid #3498db; padding-bottom: 15px;">Students Feedbacks</h3>
...
<table style="width: 100%; border-collapse: collapse; margin: 20px auto; background-color: white; font-family: Arial, sans-serif; box-shadow: 0 0 20px rgba(0,0,0,0.1); border-radius: 8px; overflow: hidden;">
    ...
    <tr style="background-color: #3498db;">
        ...
        <td style="padding: 15px;"><div style="text-align: center; color: white; font-weight: bold;">ROLL NUMBER</div></td>
        <td style="padding: 15px;"><div style="text-align: center; color: white; font-weight: bold;">FEEDBACKS</div></td>
    </tr>
    <tr>
    ...
    <tr style="transition: all 0.3s ease; hover: background-color: #f5f6fa;">
        ...
        <td style="padding: 12px; border-bottom: 1px solid #e9ecef;"><div style="text-align: center; color: #2d3436;"><?php echo $row['rollno'];?></div></td>
        <td style="padding: 12px; border-bottom: 1px solid #e9ecef;"><div style="text-align: center; color: #2d3436;"><?php echo $row['feedback'];?></div></td>
    </tr>
